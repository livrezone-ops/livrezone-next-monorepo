...
| 06/09 soir | Tests propriétaires : messagerie OK (apparent), reset password **échec** sur le formulaire, panier « un seul lien WhatsApp pour deux vendeurs ». 3 diagnostics + fixes (ci-dessous) | ✅ corrigés |
